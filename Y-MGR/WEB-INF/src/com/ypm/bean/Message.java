...
public class Message implements AState, Serializable {
	...
	private static final long serialVersionUID = 5314107161937343928L;
	...
	public String toString() {
		return this.toString(code, act);
	}

	public String toString(int code, String act) {
		if (msg == null) {
			if (sb.length() > 0) {
				sb.insert(0, AUtils.SEP[0]).insert(0, act).insert(0, "act:");
